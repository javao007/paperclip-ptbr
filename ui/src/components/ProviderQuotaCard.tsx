        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <CardDescription className="text-xs mt-0.5">
              <span className="font-mono">{formatTokens(totalInputTokens)}</span> entrada
              {" · "}
              <span className="font-mono">{formatTokens(totalOutputTokens)}</span> saída
                      ...
                      return (
                        <div key={qw.label} className="space-y-1">
                          ...
                          {qw.detail ? (
                            ...
                            <p className="text-xs text-muted-foreground">
                              reinicia {new Date(qw.resetsAt).toLocaleDateString("pt-BR", { month: "short", day: "numeric" })}
                            </p>
                          ) : null}
                        </div>
                      );
