...
import { priorityLabels, t } from "../lib/translations";

const priorityConfig: Record<string, { icon: typeof ArrowUp; color: string; label: string }> = {
  critical: { icon: AlertTriangle, color: priorityColor.critical ?? priorityColorDefault, label: t("critical", priorityLabels) },
  high: { icon: ArrowUp, color: priorityColor.high ?? priorityColorDefault, label: t("high", priorityLabels) },
  medium: { icon: Minus, color: priorityColor.medium ?? priorityColorDefault, label: t("medium", priorityLabels) },
  low: { icon: ArrowDown, color: priorityColor.low ?? priorityColorDefault, label: t("low", priorityLabels) },
};
