...
export function NewIssueDialog() {
  ...
  const createIssueErrorMessage =
    createIssue.error instanceof Error ? createIssue.error.message : "Falha ao criar tarefa. Tente novamente.";
        ...
        {currentProject && currentProjectSupportsExecutionWorkspace && (
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              <div className="text-xs font-medium">Workspace de execução</div>
              <div className="text-[11px] text-muted-foreground">
                Controle se esta tarefa roda no workspace compartilhado, em um novo workspace isolado, ou em um existente.
              </div>
              <select
              ...
              {executionWorkspaceMode === "reuse_existing" && selectedReusableExecutionWorkspace && (
                <div className="text-[11px] text-muted-foreground">
                  Reutilizando {selectedReusableExecutionWorkspace.name} de {selectedReusableExecutionWorkspace.branchName ?? selectedReusableExecutionWorkspace.cwd ?? "workspace de execução existente"}.
                </div>
              )}
            </div>
          </div>
          ...
          <div className="px-4 pb-2 shrink-0">
            ...
            {assigneeOptionsOpen && (
              <div className="mt-2 rounded-md border border-border p-3 bg-muted/20 space-y-3">
                ...
                <div className="space-y-1.5">
                  <div className="text-xs text-muted-foreground">Esforço de raciocínio</div>
                ...
                {assigneeAdapterType === "claude_local" && (
                  <div className="flex items-center justify-between rounded-md border border-border px-2 py-1.5">
                    <div className="text-xs text-muted-foreground">Habilitar Chrome (--chrome)</div>
                    <ToggleSwitch
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? "Criando..." : "Criar Tarefa"}</span>
              </span>
            </Button>
          </div>
        </div>
