...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: "Organograma" }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message="Selecione uma empresa para visualizar o organograma." />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message="Nenhum agente na organização. Crie agentes para construir seu organograma."
        />
      )}
