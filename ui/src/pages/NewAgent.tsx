...
export function NewAgent() {
  ...
  function handleSubmit() {
    ...
    if (configValues.adapterType === "opencode_local") {
      ...
      if (!selectedModel) {
        setFormError("OpenCode requer um modelo explícito no formato provedor/modelo.");
        return;
      }
      ...
      if (adapterModelsLoading || adapterModelsFetching) {
        setFormError("Os modelos OpenCode ainda estão carregando. Por favor, aguarde e tente novamente.");
        return;
      }
      ...
      if (!discovered.some((entry) => entry.id === selectedModel)) {
        setFormError(
          discovered.length === 0
            ? "Nenhum modelo OpenCode descoberto. Execute `opencode models` e autentique os provedores."
            : `Modelo OpenCode configurado indisponível: ${selectedModel}`,
        );
        return;
      }
    }
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Habilidades opcionais da biblioteca da empresa. Habilidades nativas do runtime Paperclip são adicionadas automaticamente.
              </p>
            </div>
