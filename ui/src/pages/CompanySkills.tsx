  ...
  if (filteredSkills.length === 0) {
    return (
      <div className="px-4 py-6 text-sm text-muted-foreground">
        Nenhuma habilidade corresponde a este filtro.
      </div>
    );
  }
    ...
    <div className="min-w-0">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          {detail.editable ? (
            ...
            >
              ...
              {editMode ? "Parar de editar" : "Editar"}
            </button>
          ) : (
                ...
                {detail.sourcePath ? (
                  <button
                    ...
                    onClick={() => {
                      ...
                      pushToast({ title: "Caminho copiado para a área de trabalho" });
                    }}
                  >
                    {source.label}
                  </button>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {updateStatus?.supported && updateStatus.hasUpdate && (
                  ...
                  >
                    ...
                    Instalar atualização{latestPin ? ` ${latestPin}` : ""}
                  </Button>
                )}
      ...
      <div className="min-h-[560px] px-5 py-5">
        {fileLoading ? (
          ...
          <div className="text-sm text-muted-foreground">Selecione um arquivo para inspecionar.</div>
        ) : editMode && file.editable ? (
          file.markdown ? (
            <MarkdownEditor
              value={draft}
...
export function CompanySkills() {
  ...
  const importSkill = useMutation({
    ...
    onError: (error) => {
      pushToast({
        tone: "error",
        title: "Falha na importação de habilidade",
        body: error instanceof Error ? error.message : "Falha ao importar fonte de habilidade.",
      });
    },
  });
  ...
  const createSkill = useMutation({
    ...
    onError: (error) => {
      pushToast({
        tone: "error",
        title: "Falha na criação de habilidade",
        body: error instanceof Error ? error.message : "Falha ao criar habilidade.",
      });
    },
  });
  ...
  const scanProjects = useMutation({
    ...
    onError: (error) => {
      ...
      pushToast({
        ...
        body: error instanceof Error ? error.message : "Falha ao escanear áreas de trabalho.",
      });
    },
  });
  ...
  const saveFile = useMutation({
    ...
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : "Falha ao salvar arquivo.",
      });
    },
  });
  ...
  const installUpdate = useMutation({
    ...
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : "Falha ao instalar atualização.",
      });
    },
  });

  if (!selectedCompanyId) {
    return <EmptyState icon={Boxes} message="Selecione uma empresa para gerenciar habilidades." />;
  }
    ...
    <>
      <Dialog open={emptySourceHelpOpen} onOpenChange={setEmptySourceHelpOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Adicionar uma fonte de habilidade</DialogTitle>
            <DialogDescription>
              Cole um caminho local, URL do GitHub ou comando `skills.sh` no campo primeiro.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm">
            ...
            >
              <span>
                ...
                <span className="mt-1 block text-muted-foreground">
                  Encontre comandos de instalação e cole um aqui.
                </span>
              </span>
            ...
            >
              <span>
                <span className="block font-medium">Pesquisar no GitHub</span>
                <span className="mt-1 block text-muted-foreground">
                  Procure repositórios com `SKILL.md`, depois cole a URL do repositório aqui.
                </span>
              </span>
              <ExternalLink className="mt-0.5 h-4 w-4 shrink-0 text-muted-foreground" />
            </a>
        ...
        <aside className="border-r border-border">
          <div className="border-b border-border px-4 py-3">
            <div className="flex items-center justify-between gap-2">
              <div>
                <h1 className="text-base font-semibold">Habilidades</h1>
              ...
              <div className="flex items-center gap-1">
                <Button
                  ...
                  title="Escanear áreas de trabalho do projeto por habilidades"
                >
            ...
            <div className="mt-3 flex items-center gap-2 border-b border-border pb-2">
              <input
                ...
                placeholder="Cole o caminho, URL do GitHub, ou comando skills.sh"
                className="w-full bg-transparent text-sm outline-none placeholder:text-muted-foreground"
              />
              <Button
                size="sm"
              ...
              >
                {importSkill.isPending ? <RefreshCw className="h-4 w-4 animate-spin" /> : "Adicionar"}
              </Button>
            </div>
            {scanStatusMessage && (
